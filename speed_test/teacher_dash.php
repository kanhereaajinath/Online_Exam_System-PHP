...
<td><b><a href="Teacher_update.php?q=rmquiz&eid=' . $eid . '" class="pull-right btn btn-danger" style="margin:0px; border-radius:0%;"><span class="glyphicon glyphicon-trash"  aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
                    }
                    $c = 0;
                    echo '</table></div>';
                }
...
<td><a title="Delete User" href="Teacher_update.php?demail=' . $email . '"><b><span class="glyphicon glyphicon-trash" style="color:red;" aria-hidden="true"></span></b></a></td></tr>';
                    }
                    $c = 0;
                    echo '</table></div>';
                } ?>
...
<tr><td><b>S.N.</b></td><td><b>Subject</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td></td><td></td></tr>';
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $id = $row['id'];
                        echo '<tr><td>' . $c++ . '</td>';
                        echo '<td><a title="Click to open feedback" href="teacher_dash.php?q=3&fid=' . $id . '">' . $subject . '</a></td><td>' . $email . '</td><td>' . $date . '</td><td>' . $time . '</td><td>' . $name . '</td>
	<td><a title="Open Feedback" href="teacher_dash.php?q=3&fid=' . $id . '"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
                        echo '<td><a title="Delete Feedback" href="Teacher_update.php?fdid=' . $id . '"><b><span class="glyphicon glyphicon-trash" style="color:red;" aria-hidden="true"></span></b></a></td>
	</tr>';
                    }
                    echo '</table></div>';
                }
                ...
                <?php if (@$_GET['fid']) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<div class="panel"<a title="Back to Archive" href="Teacher_update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>' . $subject . '</b></h1>';
...
<span style="line-height:35px;padding:5px;">&nbsp;<b>Time:</b>&nbsp;' . $time . '</span><span style="line-height:35px;padding:5px;">&nbsp;<b>By:</b>&nbsp;' . $name . '</span><br />' . $feedback . '</div></div>';
    ...
    <div class="container">
        <div class="">
            ...
            <div class="col-md-8"> 
                <form id="form1" class="form-horizontal title1" name="form" action="Teacher_update.php?q=addquiz" method="POST">
                    <fieldset>
<!-- Text input-->
...
<div class="form-group">
                ...
                ?>
                <!--add quiz end-->
                <!-- Second Form For Question  start -->
                <?php
                if (@$_GET['q'] == 4) {
                    echo ' 
<div class="">
<b class="button" >Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form id="form2" class="form-horizontal title1" name="form" action="Teacher_update.php?q=addqns&n=' . @$_GET['n'] . '&eid=' . @$_GET['eid'] . '&ch=4 "  method="POST">
<fieldset>
';
                    for ($i = 1; $i <= @$_GET['n']; $i++) {
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $eid = $row['eid'];
                        echo '<tr><td>' . $c++ . '</td><td>' . $title . '</td><td>' . $total . '</td><td>' . $correct * $total . '</td><td>' . $time . '&nbsp;min</td>
<td><b><a href="T_examupdate.php?' . "eid=" . $eid . '" class="glyphicon glyphicon-pencil btn btn-warning" style="margin:0px; border-radius:0%;"></span>&nbsp;<span class="title1"><b>Update</b></span></a></b></td></tr>';
                    }
                    $c = 0;
                    echo '</table></div>';
                }
